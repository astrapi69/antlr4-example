package io.github.astrapi69.antlr.log;

import io.github.astrapi69.antlr.generated.LogBaseListener;
...
public class LogListener extends LogBaseListener
{
	...
	private static final DateTimeFormatter DEFAULT_DATETIME_FORMATTER = DateTimeFormatter
		.ofPattern("yyyy-MMM-dd HH:mm:ss", Locale.ENGLISH);
	...
	{
		currentLogEntry
			.setTimestamp(LocalDateTime.parse(ctx.getText(), DEFAULT_DATETIME_FORMATTER));
	}
